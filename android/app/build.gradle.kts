...
android {
    namespace = "com.example.flutter_electricity_price_new"
    compileSdk = 36
    ...
    defaultConfig {
        ...
        applicationId = "com.bubulkapp.flutter_electricity_price_new"
...
dependencies {
    ...
    implementation("androidx.compose.material:material:1.10.0-alpha02")
}
